 ...
 * At: 18:42
 */
public class MySQLDatabase<T extends StorageModel> extends SQLDatabase<T> {

    public MySQLDatabase(MySQLCredential credential, DatabaseStructure tableStructure, Serializer<T> serializer, @NonNull Executor asyncExecutor, @NonNull Executor syncExecutor) {
